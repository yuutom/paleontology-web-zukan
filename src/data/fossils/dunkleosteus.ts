...
export const dunkleosteus: FossilSource = {
  ...
  image: "/images/dunkleosteus.png",
  description:
    "強固な頭部装甲と鋭利な顎を持つ大型魚類で、歯の代わりに骨質の刃を備えていました。デボン紀の海における脅威として知られ、硬い外殻を持つ獲物さえ噛み砕けた可能性があります。板皮類の中でも特に有名で、『魚の時代』を象徴する捕食者として高い人気を誇ります。",
};
