...
export const plesiosaur: FossilSource = {
  ...
  image: "/images/plesiosaur.png",
  description:
    "非常に長い首と四枚のヒレを持つ海生爬虫類で、中生代の海で広く繁栄しました。湖の怪物伝説とも結びつけられることがありますが、実際には海で適応放散したグループです。首の使い方や遊泳法には議論があるものの、独特の体型によって古生物の中でも特に高い知名度を持っています。",
};
