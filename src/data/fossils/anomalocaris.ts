...
export const anomalocaris: FossilSource = {
  ...
  image: "/images/anomalocaris.png",
  description:
    "カンブリア紀の海で頂点捕食者として君臨した代表的古生物です。前方の把握肢、大きな複眼、円形の口器を備え、当時としては極めて洗練された捕食能力を持っていました。カンブリア爆発期の海洋生態系で、初期動物群の複雑化と捕食圧の高まりを象徴する存在として知られています。",
};
